import { BILLING, EXACT_ROUTES } from './routes'

const { PLANS, CHECKOUT } = EXACT_ROUTES
const { BASE } = BILLING

export const EMAIL_DELIVERY_CONFIRMATION = (email: string) =>
  `We have sent an OTP to your email ${email || ''}, Please verify your account to proceed`
...
export const allowedRoutesWithoutSubscription = [PLANS, CHECKOUT, BASE]
