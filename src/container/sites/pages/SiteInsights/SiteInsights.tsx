      ...
      <Flex vertical gap={100} align="center">
        <Flex gap={64} className="circles-chart-container">
          <Flex gap={16} vertical align="center" justify="center">
            <CircularProgress color={performance ? 'success' : 'error'} progress={handleFormatCurrencyAndNumber({ value: performance })} size={140} />
        ...
        <Flex vertical gap={100}>
          <Flex gap={32} wrap align="center">
            ...
            <Container color={firstContentColor ? 'error' : 'success'} borderRadius boxShadow padding={20} className="page-insight-card container-bg">
              <Flex align="center" gap={24}>
                <BsFullscreen />
                <Flex vertical gap={8}>
            ...
            <Container color={blockingTimeColor ? 'error' : 'success'} borderRadius boxShadow padding={20} className="page-insight-card container-bg">
              <Flex align="center" gap={24}>
                <MdBlock />
                <Flex vertical gap={8}>
            ...
            <Container color={layoutShiftColor ? 'error' : 'success'} borderRadius boxShadow padding={20} className="page-insight-card container-bg">
