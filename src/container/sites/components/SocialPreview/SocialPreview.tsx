...
const SocialPreview = () => {
  ...
  const accordionDescription = (
    <Flex vertical gap={4}>
      ...
      <Typography text="Ali Liaila story changed to other story" color="warning" />
  ...
  return (
    <Container borderRadius boxShadow width={100} className="recommendation-list-container" padding={'40px 20px'}>
      <Flex vertical gap={16}>
        ...
        <Flex vertical gap={10}>
          <Accordion
            ...
            color="primary"
            CustomIcon={
              <Button size="sm" variant="outlined" onClick={onApprove} type="borderRadius" color="success">
                Approve
              </Button>
            }
          />
